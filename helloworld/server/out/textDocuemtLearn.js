...
(function (Tag) {
    ...
    Tag[Tag["KW_RETURN"] = 58] = "KW_RETURN";
    ...
    Tag[Tag["KW_DESTROY"] = 118] = "KW_DESTROY";
    ...
    Tag[Tag["KW_TIME"] = 127] = "KW_TIME";
    Tag[Tag["KW_ACTIVATE"] = 128] = "KW_ACTIVATE";
    Tag[Tag["LABEL"] = 129] = "LABEL";
    Tag[Tag["KW_DESTROYZERO"] = 130] = "KW_DESTROYZERO";
    Tag[Tag["KW_PRIORITY"] = 131] = "KW_PRIORITY";
    Tag[Tag["KW_ORDER"] = 132] = "KW_ORDER"; //顺序
            ...
            //判断符号
                ...
                if (charNow === "'") {
                    ...
                    if (charNow === "~") {
                        ...
                        let myTokenOffsetBegin = this.myLexDocument.myDocumentOffset - 1;
